...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # new_expressions = Pair(symbol, Pair(Pair('lambda', Pair(signature.rest, expressions.rest)), nil))
        # do_define_form(new_expressions, env)
        # return symbol

        # second way
        symbol, procedure = signature.first, do_lambda_form(Pair(signature.rest, expressions.rest), env)
